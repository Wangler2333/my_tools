...
history_file = os.path.join(resources, "history.txt")
if not os.path.isfile(history_file):
    f = open(history_file, "w")
    f.write(str(history_info))
    f.close()
...
class AuditTools(QMainWindow, Ui_MainWindow):
    ...
    def set_up_item(self, dict_):
        ...
        source_command_path = command_define_path + tmp_dict["cmd-link"]
        source_config_path = command_define_path + tmp_dict["config"]
