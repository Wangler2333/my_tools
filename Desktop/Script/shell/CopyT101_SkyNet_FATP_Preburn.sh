...
LogPath=/Phoenix/tmp
DATE=`date +%Y%m%d`
T101LogFolder="/Phoenix/Logs/T101Cal_PreburnLog"
...
FinalLogName=SkyNet_"$Product"_"$Stage"_PreT101"$TestName"_"$SerialNumber"_"$timeflag".csv
FinalFolderName=SkyNet_"$Product"_"$Stage"_T101"$TestName"_"SerialNumber"_"$zipfile"
