...
nvram boot-args="debug=0x8c44 -v kdp_match_name=serial sdxc=0xA0000 dither=0 watchdog=0 blc_disable_fault=1 medetect_panic=1 tb=0x400 usb-no-rtpc=1 intcoproc_unrestricted=1 serial=3"
sleep 1
