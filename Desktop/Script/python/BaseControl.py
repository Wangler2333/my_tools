...
class CBaseControl(CBaseCommand):
    ...
    def CheckFinished(self):
        if len(self.dictSendingRelayerControls.keys())>0:
            for relayer_id in self.dictSendingRelayerControls.keys():
