...
############note###########################################
#####                                  ####################
#####Please use External clock =27MHz####################
#####                                  ####################
###########################################################
...
##    WriteReg(0x18,0x51,0x20)    #LC=2.7G
    ...
    sleep(0.01)
    WriteReg(0x18,0x50,0xa5)    #enable LC, LC=3.405G
    WriteReg(0x18,0x51,0x3d)    #LC=3.405G
...
##    ####clock setting
    ...
    WriteReg(0x14, 0x02, 0x70);	##ni and nf of the vclk
    WriteReg(0x14, 0x03, 0xc7);	####start & load & band & ni[7:6]
    #### sclk 400 MHz
    WriteReg(0x14, 0x05, 0x00);	####nf of the sclk
    WriteReg(0x14, 0x06, 0xee);	##ni and nf of the sclk
...
##    WriteReg(0x14, 0x07, 0x41);	####start & load & band & ni[7:5]
    ...
    WriteReg(0x14, 0x0b, 0xa8);	##ni and nf of the cogclk
    WriteReg(0x14, 0x0c, 0xc0);	##band & ni[7:6]
...
##    WriteReg(0x18, 0x4f, 0x88)	##slice 3
##    WriteReg(0x18, 0x63, 0x88)	##slice CA
##    WriteReg(0x18, 0x11, 0x88)	 ##slice 0
##    WriteReg(0x18, 0x25, 0x88)	 ##slice 1
##    WriteReg(0x18, 0x39, 0x88)	 ##slice 2
##    WriteReg(0x18, 0x4d, 0x88)	 ##slice 3
##    WriteReg(0x18, 0x61, 0x88)	 ##slice CA
##    WriteReg(0x18, 0x0f, 0x00)
##    WriteReg(0x18, 0x23, 0x00)
##    WriteReg(0x18, 0x37, 0x00)
##    WriteReg(0x18, 0x4b, 0x00)
##    WriteReg(0x18, 0x5f, 0x00)
##    WriteReg(0x18, 0x07, 0xc6)
##    WriteReg(0x18, 0x1b, 0xc6)
##    WriteReg(0x18, 0x2f, 0xc6)
##    WriteReg(0x18, 0x43, 0xc6)
##    WriteReg(0x18, 0x65, 0x08)
##    WriteReg(0x18,0xff,0x00);
...
##======================11.	CRC check
    ...
    CRC1_fail=ReadRegCompare(0x1a,0x09,0xa6,0xff)
    WriteReg(0x1a,0x84,0x13)
    CRC2_fail=ReadRegCompare(0x1a,0x09,0x36,0xff)
    WriteReg(0x1a,0x84,0x23)
    CRC3_fail=ReadRegCompare(0x1a,0x09,0xa6,0xff)
    WriteReg(0x1a,0x84,0x33)
    CRC4_fail=ReadRegCompare(0x1a,0x09,0x36,0xff)
    WriteReg(0x1a,0x84,0x43)
    CRC5_fail=ReadRegCompare(0x1a,0x09,0xa6,0xff)
    WriteReg(0x1a,0x84,0x53)
    CRC6_fail=ReadRegCompare(0x1a,0x09,0x36,0xff)
##    sleep(0.01)
##    WriteReg(0x1a,0x84,0x00)
##    sleep(0.05)
    ...
    CRC_fail=CRC1_fail|CRC2_fail|CRC3_fail|CRC4_fail|CRC5_fail|CRC6_fail|CRC7_fail|RFB1_fail|RFB2_fail|RFB3_fail
...
##======================12.	Signature check
    ...
    WriteReg(0x14,0x09,0x02)
    sleep(0.2)
    WriteReg(0x14,0x09,0x0f)
    sleep(0.2)         
    print ''
    print 'start cheching signalture!'
    print 'without PIO loopback'
    WriteReg(0x16,0xf7,0x00)
    sleep(0.01)
    WriteReg(0x16,0xf7,0x01) ##COG_LB_en=0
    WriteReg(0x16,0x11,0x02)
    sleep(0.01)
    WriteReg(0x16,0x11,0x03)
    sleep(0.05) #wait signature stable
    Sig11_fail=ReadRegCompare(0x16,0xf9,0xb6,0xff)
    Sig12_fail=ReadRegCompare(0x16,0xfa,0x00,0xff)
    Sig13_fail=ReadRegCompare(0x16,0xfb,0xb6,0xff)
    Sig14_fail=ReadRegCompare(0x16,0xfc,0x00,0xff)
    ...
    sleep(0.05) #wait signature stable
    Sig21_fail=ReadRegCompare(0x16,0xf9,0xb6,0xff)
    Sig22_fail=ReadRegCompare(0x16,0xfa,0x00,0xff)
    Sig23_fail=ReadRegCompare(0x16,0xfb,0xb6,0xff)
    Sig24_fail=ReadRegCompare(0x16,0xfc,0x00,0xff)
