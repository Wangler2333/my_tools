...
class MyFrame(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, title="Multi-threaded GUI",size=(600,300),style=wx.CLOSE_BOX | wx.MAXIMIZE_BOX | wx.MINIMIZE_BOX)
        self.threads = []
        self.count = 0
        ...
        self.log = wx.TextCtrl(panel, -1, "", pos=(20,40),size=(500,200),style=wx.TE_RICH | wx.TE_MULTILINE)
